...
import com.dynamicvoyage.thehunted.item.custom.HunterRodItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> HUNTER_ROD = createNewTool("hunter_rod", defaultToolProperties.durability(1));
    ...
    public static RegistryObject<Item> createNewTool(String name, Item.Properties properties ) {
        properties.tab(ModCreativeModeTab.TAB_THEHUNTED);
        return ITEMS.register(name, () -> new HunterRodItem(properties));
    }
